...
import com.minhuitianxia.myapplication.Fragment.YKVipLoginFragment;
 ...
 */
public class MainActivityyk extends AppCompatActivity {
    ...
    private YKVipLoginFragment ykvip;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            if ("12".equals(isExit)) {
                // 记录当前Fragment
                mCurrentTag = FragmentTag.TAG_YK;
                ...
                getSupportFragmentManager()
                        ...
                        .add(R.id.main_fragment, ykvip, TAG_YK.getTag())
//                        .add(R.id.main_fragment,vip_fragment,mTAG_VIPINFO.getTag())
                        .hide(mallF).hide(ykvip).show(mCurrentFragment).commit();

            }
        }
        ykvip.setOnButtonClick(new YKVipLoginFragment.OnButtonClick() {
            @Override
...
//        rb_merchant = (RadioButton) findViewById(R.id.rb_merchant);
        ...
        ykvip = new YKVipLoginFragment();//会员
                ...
                switch (checkedId) {
                    ...
                    case R.id.rb_vip://会员
                        if(ISLogin){
                            ...
                            switchFragment(FragmentTag.TAG_YK);
                            radioGroup.check(R.id.rb_vip);
                        }
                        isCurrF = 3;
                        break;
